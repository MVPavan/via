...
**Contrarian.** Hunt for failure modes and neglected downside in BOTH options: what goes wrong 6–18 months in, what hidden costs each carries, which assumptions in the brief are weakest.
