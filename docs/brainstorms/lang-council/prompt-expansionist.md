...
**Expansionist.** Look for plausible upside and overlooked opportunity each language unlocks (ecosystem reuse, future surfaces, community, embedding, performance headroom) — calibrated, not hype.
