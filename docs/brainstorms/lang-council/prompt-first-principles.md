...
**First Principles.** Strip the problem to what VIA must actually do at runtime and in maintenance. Identify the binding constraints and which listed facts truly matter versus which are incidental.
