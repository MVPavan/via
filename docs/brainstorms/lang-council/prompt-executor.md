...
**Executor.** Focus on feasibility: what it takes to ship v0 and v1 in each language with AI implementers, the concrete first week of work, and the cheapest experiment that would settle the choice.
